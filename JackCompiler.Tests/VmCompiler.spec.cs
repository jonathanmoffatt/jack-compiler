...
";
    ...
    #region WhenCompilingAverage

    [TestClass]
    public class WhenCompilingAverage
    {
        private VmCompiler classUnderTest;
...
";
        ...
        const string vmOutput = @"function Main.main 4
push constant 18
call String.new 1
push constant 72
...
";
    ...
    #region WhenCompilingComplexArrays

    [TestClass]
    public class WhenCompilingComplexArrays
    {
        private VmCompiler classUnderTest;
...
";
        const string vmOutput = @"function Main.main 3
push constant 10
call Array.new 1
pop local 0
push constant 5
